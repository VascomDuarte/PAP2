      ...
      <div className="pt-40 max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2 pb-[90px]">
          ...
          <p className="px-4 py-4 text-black">
            ...
            Batalha, intitulado Talhos Grosso, mas com o intuito de expandir a sua actividade a outros
            locais, abriu outro estabelecimento no Mercado Municipal de Porto de
            Mós em 1984 ( que mais tarde encerrou), e outro situado na
            localidade do Juncal.
          </p>
          <p className="px-4 py-4 text-black">
            ...
            Centro e outros clientes não tão conhecidos
            mas não mais importantes que todos os outros atrás mencionados.
            <br />
          </p>
          <p href="/contactos" className="px-4 py-4 text-black underline cursor-pointer">
